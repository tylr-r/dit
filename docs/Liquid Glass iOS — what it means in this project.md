...
- We already have a **web UI** that looks good, iOS is a separate implementation optimized for:
  ...
  - native iOS feel
  - automatic adoption of Apple’s current UI style
...
The fastest way to *prevent* Liquid Glass is to add custom styling on top of controls/navigation.
...
## Rule 5: Accessibility and system settings must work
Native controls should automatically adapt to:
- dark mode
- dynamic type
- reduce transparency / reduce motion

## Rule 6: Do not change the MorseButton
